...
#set_property PACKAGE_PIN U4 [get_ports rs_i]					
	#set_property IOSTANDARD LVCMOS33 [get_ports rs_i]
...
#set_property PACKAGE_PIN T8 [get_ports lcd_enable_led]					
	#set_property IOSTANDARD LVCMOS33 [get_ports lcd_enable_led]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports lcd_busy_led]					
	#set_property IOSTANDARD LVCMOS33 [get_ports lcd_busy_led]
...
set_property PACKAGE_PIN E16 [get_ports ir_giris]						
	set_property IOSTANDARD LVCMOS33 [get_ports ir_giris]
...
set_property PACKAGE_PIN R10 [get_ports reset_sayi]						
	set_property IOSTANDARD LVCMOS33 [get_ports reset_sayi]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
#set_property PACKAGE_PIN V10 [get_ports ir_giris]						
	#set_property IOSTANDARD LVCMOS33 [get_ports ir_giris]
...
set_property PACKAGE_PIN H4 [get_ports ir_giris]					
	set_property IOSTANDARD LVCMOS33 [get_ports ir_giris]
